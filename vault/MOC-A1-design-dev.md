...
tags: [moc, axis-a1, design, development]
---

# MOC-A1 — 설계 & 개발 (Claude + Jin)

A1 축 = **Claude + Jin 이 함께 설계·개발하는 두뇌**. 헌장 → 결정(ADR) → 컴포넌트 spec → 리서치/디베이트로 흐르는 develop-side 지식. 봇이 무엇을·왜 그렇게 만들어졌는지의 출처(provenance).

## 헌장 (constitution)
- [[north-star]] — 0.75% primary / 1.25% stretch / aggressive bias
- [[aggressive-bias]] — defensive 거부 영속 원칙
- [[active-autonomous-vision]] — per-gate AI / dynamic universe / 자가진화
...
- [[layer-2-per-gate-pipeline]] · [[layer-3-sizing-risk]]
- [[layer-4-cell-matrix]] · [[layer-5-learner-network]]
- [[layer-6-live-recalc]] · [[layer-7-strategy-isolation]]
...
---
## 축 연결
- [[MOC-A2-bot-ops]] — 이 설계가 굴러가는 봇 운영
- [[MOC-A3-raw-data]] — 설계가 생산/소비하는 DB 로우데이터
