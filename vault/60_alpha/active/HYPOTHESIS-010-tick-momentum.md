...
# HYPO-010 — 24h change + high proximity

## Hypothesis
**tick-driven momentum** — 24h change + high proximity 가 OKX SPOT live fee 0.14% (round-trip) 통과 + paper 30+ trades 후 expectancy > 0.

## Method (Realtime tick-driven, ADR-012)
- WebSocket OKX SPOT
- Tickers: 10 majors
- Fee: 0.0014 (LV3 가정)
- Code: src/strategies/tick_momentum.py
...
- src/strategies/tick_momentum.py
