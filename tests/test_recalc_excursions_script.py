...
def _seed_db(db: Path) -> None:
    ...
    conn.execute(
        ...
        "VALUES ('pos-distort', 'okx', 'BTC-USDT', 'crypto:BTC', 'tsmom', "
        " 'tsmom', 'tsmom', 'long', 0.001, 'closed', ?, 0, 103.0, 99.0, "
        " 15.0, -5.0)",
        (OPENED,),
    )
    conn.execute(
        ...
        "VALUES (?, ?, 'tsmom', 'okx:BTC-USDT', 'okx', 'long', 0.001, 100.0, "
    ...
    conn.execute(
        ...
        " entry_strategy_id, active_strategy_id, side, qty, status, opened_ts, "
        " swap_count) "
        "VALUES ('pos-noext', 'okx', 'BTC-USDT', 'crypto:BTC', 'tsmom', "
        " 'tsmom', 'tsmom', 'long', 0.001, 'closed', ?, 0)",
        (OPENED,),
    )
    ...
    conn.execute(
        ...
        "VALUES ('pos-nofill', 'okx', 'BTC-USDT', 'crypto:BTC', 'tsmom', "
        " 'tsmom', 'tsmom', 'long', 0.001, 'closed', ?, 0, 101.0, 99.5)",
        (OPENED,),
    )
    ...
    conn.execute(
        ...
        " entry_strategy_id, active_strategy_id, side, qty, status, opened_ts, "
        " swap_count, peak_price, trough_price) "
        "VALUES ('pos-nobars', 'okx', 'XYZ-USDT', 'crypto:XYZ', 'tsmom', "
        " 'tsmom', 'tsmom', 'long', 0.001, 'closed', ?, 0, 101.0, 99.5)",
        (OPENED,),
    )
    conn.execute(
        ...
        " fill_price, size_usd, fee_usd, slippage_bps, pnl_usd, is_close, "
        " contribution_id, order_id, state) "
        "VALUES (?, ?, 'tsmom', 'okx:XYZ-USDT', 'okx', 'long', 0.001, 100.0, "
