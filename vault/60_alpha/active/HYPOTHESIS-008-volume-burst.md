...
# HYPO-008 — 1h vol > 1.5x SMA + bullish

## Hypothesis
**momentum** — 1h vol > 1.5x SMA + bullish 가 OKX SPOT live fee 0.14% (round-trip) 통과 + paper 30+ trades 후 expectancy > 0.

## Method (Realtime tick-driven, ADR-012)
- WebSocket OKX SPOT
- Tickers: ORDI/DOGE/SOL/PEPE/TRUMP
- Fee: 0.0014 (LV3 가정)
- Code: src/strategies/volume_burst.py
...
- src/strategies/volume_burst.py
