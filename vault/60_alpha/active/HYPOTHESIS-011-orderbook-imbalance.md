...
# HYPO-011 — books5 bid/ask sum imbalance > 0.62

## Hypothesis
**order book** — books5 bid/ask sum imbalance > 0.62 가 OKX SPOT live fee 0.14% (round-trip) 통과 + paper 30+ trades 후 expectancy > 0.

## Method (Realtime tick-driven, ADR-012)
- WebSocket OKX SPOT
- Tickers: 8 majors
- Fee: 0.0014 (LV3 가정)
- Code: src/strategies/orderbook_imbalance.py
...
- src/strategies/orderbook_imbalance.py
