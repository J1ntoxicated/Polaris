...
tags: [agent, gate, opus-devspawn, python-p0, learning]
related: [[ADR-004]], [[ADR-006]], [[ADR-007]]
model: claude-opus-4-8  # dev-spawn 도메인 추론; 봇 런타임 AI gate=GPT, P0=Python lesson template
---

# post-trade-reflector (Gate 8 — dev-spawn Opus / 런타임 GPT / Python P0)
