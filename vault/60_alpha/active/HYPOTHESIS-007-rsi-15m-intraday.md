...
# HYPO-007 — RSI 15m oversold reversal

## Hypothesis
**intraday mean-reversion** — RSI 15m oversold reversal 가 OKX SPOT live fee 0.14% (round-trip) 통과 + paper 30+ trades 후 expectancy > 0.

## Method (Realtime tick-driven, ADR-012)
- WebSocket OKX SPOT
- Tickers: BTC/DOGE/PEPE/SUI/ADA/TRUMP
- Fee: 0.0014 (LV3 가정)
- Code: src/strategies/rsi_15m_intraday.py
...
- src/strategies/rsi_15m_intraday.py
