...
# HYPO-009 — N-bar high break + bullish

## Hypothesis
**trend continuation** — N-bar high break + bullish 가 OKX SPOT live fee 0.14% (round-trip) 통과 + paper 30+ trades 후 expectancy > 0.

## Method (Realtime tick-driven, ADR-012)
- WebSocket OKX SPOT
- Tickers: DOGE/PEPE/ORDI
- Fee: 0.0014 (LV3 가정)
- Code: src/strategies/breakout_momentum.py
